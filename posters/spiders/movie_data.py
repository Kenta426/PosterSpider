...
class PosterSpider(scrapy.Spider):
    name = "movie-spider"
    urls = []
    # get all top 250 most popular movies from 1997 - 2006
    for i in range(10):
        year = 1997 + i
    ...
    # from the list of movie, get the url to the each page for the movie page
    ...
    # from the movie page, extract relevant information and create scrapy item
